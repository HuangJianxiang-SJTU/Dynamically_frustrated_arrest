...
This release aligns the deposited data, scripts, figures, and documentation with the revised manuscript submitted to *Nucleic Acids Research* (NAR-02689-H-2026).
...
- Replaced "evolutionary constraint" with "VESM-3B substitution intolerance" in code, tables, figures, and documentation. VESM-3B is identified as using an ESM2-3B backbone loaded with VESM distilled weights; its sign-inverted mean LLR is not direct sequence conservation.
